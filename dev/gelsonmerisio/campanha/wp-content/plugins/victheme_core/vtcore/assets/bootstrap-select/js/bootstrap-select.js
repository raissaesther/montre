...
(function ($) {
  ...
  $(window).on('load.bs.select.data-api ajaxComplete.bs.select.data-api', function () {
    $('.selectpicker').each(function () {
      var $selectpicker = $(this), data = {};

      if ($selectpicker.data('selectpicker-options')) {
        data = $selectpicker.data('selectpicker-options');
      }
      else {
        data = $selectpicker.data();
      }

      Plugin.call($selectpicker, data);
    })
  });
})(jQuery);
