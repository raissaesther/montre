        	...
        	<div class="auto-container">
            	<div class="outer-container clearfix">
                    ...
                    <div class="logo-box">
                        ...
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url(timisoara_set($options, 'logo')); ?>" alt="<?php esc_attr_e('Logo', 'timisoara');?>" title="<?php esc_attr_e('Title', 'timisoara');?>"></a>
                        <?php else: ?>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right search-panel" aria-labelledby="dropdownMenu3">
                                            <li class="panel-outer">
                                                <div class="<?php echo esc_url(home_url('/')); ?>">
                                                    <form method="post" action="blog.html">
                                                        <div class="form-group">
                                                            <input type="search" name="field-name" value="" placeholder="<?php echo esc_attr(timisoara_set($options, 'search_textx')); ?>" required>
