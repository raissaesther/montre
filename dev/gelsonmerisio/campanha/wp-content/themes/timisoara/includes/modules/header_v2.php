        	...
        	<div class="auto-container">
            	<div class="outer-container clearfix">
                    ...
                    <div class="logo-box">
						...
						<?php if(timisoara_set($options, 'logo2')): ?>
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url(timisoara_set($options, 'logo2')); ?>" alt="<?php esc_attr_e('Logo', 'timisoara');?>" title="<?php esc_attr_e('Title', 'timisoara');?>"></a>
                        <?php else: ?>
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url(get_template_directory_uri().'/images/logo2.png'); ?>" alt="<?php esc_attr_e('Image', 'timisoara');?>"></a>
                        <?php endif; ?>
					</div>
                    </div>
                    <!--Nav Outer-->
