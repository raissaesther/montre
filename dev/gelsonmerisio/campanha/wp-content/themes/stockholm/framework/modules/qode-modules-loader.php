...
if ( ! function_exists( 'qode_load_widget_class' ) ) {
	/**
	 * Loades widget class file.
	 */
	function qode_load_widget_class() {
		include_once QODE_FRAMEWORK_MODULES_ROOT_DIR . '/widgets/lib/widget-class.php';
	}

	add_action( 'qode_before_options_map', 'qode_load_widget_class' );
}

if ( ! function_exists( 'qode_load_widgets' ) ) {
	/**
	 * Loades all widgets by going through all folders that are placed directly in widgets folder
	 * and loads load.php file in each. Hooks to qode_after_options_map action
	 */
	function qode_load_widgets() {
	...
	add_action( 'qode_before_options_map', 'qode_load_widgets' );
}