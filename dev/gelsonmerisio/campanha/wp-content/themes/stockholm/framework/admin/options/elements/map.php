...
$elementsPage->addChild("panel1",$panel1);
	...
	$group1->addChild("row2",$row2);
			...
			$back_to_top_border_width = new QodeField("textsimple","back_to_top_border_width","","Border Width(px)","");
			$row2->addChild("back_to_top_border_width",$back_to_top_border_width);
	$row3 = new QodeRow(true);
	$group1->addChild("row3",$row3);

		$back_to_top_width = new QodeField("textsimple","back_to_top_width","","Width(px)","");
		$row3->addChild("back_to_top_width",$back_to_top_width);

		$back_to_top_height = new QodeField("textsimple","back_to_top_height","","Height(px)","");
		$row3->addChild("back_to_top_height",$back_to_top_height);
...
$elementsPage->addChild("panel2",$panel2);
	...
	$panel2->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$button_title_texttransform = new QodeField("selectblanksimple","button_title_texttransform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row4",$row4);
			...
			$button_padding = new QodeField("textsimple","button_padding","","Padding left/right (px)","This is some description");
			$row4->addChild("button_padding",$button_padding);
	...
	$panel2->addChild("group3",$group3);
		...
		$group_underlined_button = new QodeGroup("Predifined Underlined Button","Define underlined button style.");
		$panel2->addChild("group_underlined_button",$group_underlined_button);
		$row1 = new QodeRow();
		$group_underlined_button->addChild("row1",$row1);

		$button_underlined_text_color = new QodeField("colorsimple","button_underlined_text_color","","Text Color","This is some description");
		$row1->addChild("button_underlined_text_color",$button_underlined_text_color);

		$button_underlined_text_color_hover = new QodeField("colorsimple","button_underlined_text_color_hover","","Text Hover Color","This is some description");
		$row1->addChild("button_underlined_text_color_hover",$button_underlined_text_color_hover);

		$button_underlined_border_color = new QodeField("colorsimple","button_underlined_border_color","","Border Color","This is some description");
		$row1->addChild("button_underlined_border_color",$button_underlined_border_color);

		$button_underlined_border_color_hover = new QodeField("colorsimple","button_underlined_border_color_hover","","Border Hover Color","This is some description");
		$row1->addChild("button_underlined_border_color_hover",$button_underlined_border_color_hover);
...
$elementsPage->addChild("panel3",$panel3);
	...
	$panel3->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$blockquote_text_transform = new QodeField("selectblanksimple","blockquote_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$blockquote_font_style = new QodeField("selectblanksimple","blockquote_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blockquote_font_style",$blockquote_font_style);

			$blockquote_font_weight = new QodeField("selectblanksimple","blockquote_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$elementsPage->addChild("panel20",$panel20);
	...
	$panel20->addChild("group1",$group1);
		...
		$group1->addChild("row2",$row2);
			...
			$countdown_fontweight = new QodeField("selectblanksimple","countdown_fontweight","","Numeral Font Weight","This is some description",qode_get_font_weight_array());
		...
		$group1->addChild("row3",$row3);
			...
			$countdown_text_fontweight = new QodeField("selectblanksimple","countdown_text_fontweight","","Text Font Weight","This is some description",qode_get_font_weight_array());
			$row3->addChild("countdown_text_fontweight",$countdown_text_fontweight);

			$countdown_text_texttransform = new QodeField("selectblanksimple","countdown_text_texttransform","","Text Transform","This is some description",qode_get_text_transform_array());
...
$elementsPage->addChild("panel5",$panel5);
	...
	$panel5->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$expandable_label_text_transform = new QodeField("selectblanksimple","expandable_label_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$expandable_label_font_weight = new QodeField("selectblanksimple","expandable_label_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$elementsPage->addChild("panel10",$panel10);
	...
	$panel10->addChild("group1",$group1);
		...
		$group1->addChild("row2",$row2);
			...
			$pagination_text_transform = new QodeField("selectblanksimple","pagination_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
			...
			$pagination_font_style = new QodeField("selectblanksimple","pagination_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("pagination_font_style",$pagination_font_style);

			$pagination_font_weight = new QodeField("selectblanksimple","pagination_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$elementsPage->addChild("panel12",$panel12);	
	...
	$panel12->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$pricing_tables_active_text_text_transform = new QodeField("selectblanksimple","pricing_tables_active_text_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group2->addChild("row2",$row2);
			...
			$pricing_tables_active_text_font_style = new QodeField("selectblanksimple","pricing_tables_active_text_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("pricing_tables_active_text_font_style",$pricing_tables_active_text_font_style);

			$pricing_tables_active_text_font_weight = new QodeField("selectblanksimple","pricing_tables_active_text_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel12->addChild("group3",$group3);
		...
		$group3->addChild("row1",$row1);
			...
			$pricing_tables_title_text_transform = new QodeField("selectblanksimple","pricing_tables_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group3->addChild("row2",$row2);
			...
			$pricing_tables_title_font_style = new QodeField("selectblanksimple","pricing_tables_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("pricing_tables_title_font_style",$pricing_tables_title_font_style);

			$pricing_tables_title_font_weight = new QodeField("selectblanksimple","pricing_tables_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel12->addChild("group4",$group4);
		...
		$group4->addChild("row1",$row1);
			...
			$pricing_tables_period_text_transform = new QodeField("selectblanksimple","pricing_tables_period_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group4->addChild("row2",$row2);
			...
			$pricing_tables_period_font_style = new QodeField("selectblanksimple","pricing_tables_period_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("pricing_tables_period_font_style",$pricing_tables_period_font_style);

			$pricing_tables_period_font_weight = new QodeField("selectblanksimple","pricing_tables_period_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel12->addChild("group5",$group5);
		...
		$group5->addChild("row1",$row1);
			...
			$pricing_tables_price_text_transform = new QodeField("selectblanksimple","pricing_tables_price_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group5->addChild("row2",$row2);
			...
			$pricing_tables_price_font_style = new QodeField("selectblanksimple","pricing_tables_price_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("pricing_tables_price_font_style",$pricing_tables_price_font_style);

			$pricing_tables_price_font_weight = new QodeField("selectblanksimple","pricing_tables_price_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel12->addChild("group6",$group6);
		...
		$group6->addChild("row1",$row1);
			...
			$pricing_tables_currency_text_transform = new QodeField("selectblanksimple","pricing_tables_currency_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group6->addChild("row2",$row2);
			...
			$pricing_tables_currency_font_style = new QodeField("selectblanksimple","pricing_tables_currency_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("pricing_tables_currency_font_style",$pricing_tables_currency_font_style);

			$pricing_tables_currency_font_weight = new QodeField("selectblanksimple","pricing_tables_currency_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel12->addChild("group7",$group7);
		...
		$group7->addChild("row1",$row1);
			...
			$pricing_tables_button_text_transform = new QodeField("selectblanksimple","pricing_tables_button_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group7->addChild("row2",$row2);
			...
			$pricing_tables_button_font_style = new QodeField("selectblanksimple","pricing_tables_button_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("pricing_tables_button_font_style",$pricing_tables_button_font_style);

			$pricing_tables_button_font_weight = new QodeField("selectblanksimple","pricing_tables_button_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$elementsPage->addChild("panel19",$panel19);
		...
		$panel19->addChild("group1",$group1);
			...
			$group1->addChild("row1",$row1);
				...
				$pricing_lists_title_text_transform = new QodeField("selectblanksimple","pricing_lists_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
			...
			$group1->addChild("row2",$row2);
				...
				$pricing_lists_title_font_style = new QodeField("selectblanksimple","pricing_lists_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
				$row2->addChild("pricing_lists_title_font_style",$pricing_lists_title_font_style);

				$pricing_lists_title_font_weight = new QodeField("selectblanksimple","pricing_lists_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
		...
		$panel19->addChild("group2",$group2);
			...
			$group2->addChild("row1",$row1);
				...
				$pricing_lists_price_text_transform = new QodeField("selectblanksimple","pricing_lists_price_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
			...
			$group2->addChild("row2",$row2);
				...
				$pricing_lists_price_font_style = new QodeField("selectblanksimple","pricing_lists_price_font_style","","Font Style","This is some description",qode_get_font_style_array());
				$row2->addChild("pricing_lists_price_font_style",$pricing_lists_price_font_style);

				$pricing_lists_price_font_weight = new QodeField("selectblanksimple","pricing_lists_price_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
		...
		$panel19->addChild("group3",$group3);
			...
			$group3->addChild("row1",$row1);
				...
				$pricing_lists_text_text_transform = new QodeField("selectblanksimple","pricing_lists_text_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
			...
			$group3->addChild("row2",$row2);
				...
				$pricing_lists_text_font_style = new QodeField("selectblanksimple","pricing_lists_text_font_style","","Font Style","This is some description",qode_get_font_style_array());
				$row2->addChild("pricing_lists_text_font_style",$pricing_lists_text_font_style);

				$pricing_lists_text_font_weight = new QodeField("selectblanksimple","pricing_lists_text_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
		...
		$panel19->addChild("group4",$group4);
			...
			$group4->addChild("row1",$row1);
				...
				$pricing_lists_highlighted_text_text_transform = new QodeField("selectblanksimple","pricing_lists_highlighted_text_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
			...
			$group4->addChild("row2",$row2);
				...
				$pricing_lists_highlighted_text_font_style = new QodeField("selectblanksimple","pricing_lists_highlighted_text_font_style","","Font Style","This is some description",qode_get_font_style_array());
				$row2->addChild("pricing_lists_highlighted_text_font_style",$pricing_lists_highlighted_text_font_style);

				$pricing_lists_highlighted_text_font_weight = new QodeField("selectblanksimple","pricing_lists_highlighted_text_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$elementsPage->addChild("panel9",$panel9);
	...
	$panel9->addChild("group1",$group1);
		...
		$group1->addChild("row2",$row2);
			...
			$navigation_border_width = new QodeField("textsimple","navigation_border_width","","Border Width (px)","This is some description");
			$row2->addChild("navigation_border_width",$navigation_border_width);

		$row3 = new QodeRow(true);
		$group1->addChild("row3",$row3);
			$navigation_width = new QodeField("textsimple","navigation_width","","Width (px)","This is some description");
			$row3->addChild("navigation_width",$navigation_width);

			$navigation_height = new QodeField("textsimple","navigation_height","","Height (px)","This is some description");
			$row3->addChild("navigation_height",$navigation_height);
...
$elementsPage->addChild("panel15",$panel15);
	...
	$panel15->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$tabs_fontweight = new QodeField("selectblanksimple","tabs_fontweight","","Tab Font Weight","This is some description",qode_get_font_weight_array());
		...
		$group1->addChild("row2",$row2);	
			...
			$tab_text_text_transform = new QodeField("selectblanksimple","tab_text_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
			$row1->addChild("tab_text_text_transform",$tab_text_text_transform);

		$row3 = new QodeRow(true);
		$group1->addChild("row3",$row3);

		$tab_bottom_border_color = new QodeField("colorsimple","tab_bottom_border_color","","Tab bottom border color","This is some description");
		$row2->addChild("tab_bottom_border_color",$tab_bottom_border_color);
...
$elementsPage->addChild("panel18",$panel18);
	...
	$panel18->addChild("group1",$group1);
		...
		$group1->addChild("row3",$row3);
			...
			$row3->addChild("tags_border_color",$tags_border_color);

		$row4 = new QodeRow(true);
		$group1->addChild("row4",$row4);

			$tags_border_hover_color = new QodeField("colorsimple","tags_border_hover_color","","Hover Border color","This is some description");
...
$elementsPage->addChild("panel16",$panel16);
	...
	$panel16->addChild("group4",$group4);
		...
		$group4->addChild("row1",$row1);
			...
			$testimonials_title_text_transform = new QodeField("selectblanksimple","testimonials_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group4->addChild("row2",$row2);
			...
			$testimonials_title_font_style = new QodeField("selectblanksimple","testimonials_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("testimonials_title_font_style",$testimonials_title_font_style);

			$testimonials_title_font_weight = new QodeField("selectblanksimple","testimonials_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel16->addChild("group5",$group5);
		...
		$group5->addChild("row1",$row1);
			...
			$testimonials_author_job_text_transform = new QodeField("selectblanksimple","testimonials_author_job_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group5->addChild("row2",$row2);
			...
			$testimonials_author_job_font_style = new QodeField("selectblanksimple","testimonials_author_job_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("testimonials_author_job_font_style",$testimonials_author_job_font_style);

			$testimonials_author_job_font_weight = new QodeField("selectblanksimple","testimonials_author_job_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
