...
qode_framework()->qodeOptions->addAdminPage("sidebar",$sidebarPage);
...
$sidebarPage->addChild("panel1",$panel1);
	...
	$panel1->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$sidebar_title_text_transform = new QodeField("selectblanksimple","sidebar_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$sidebar_title_font_style = new QodeField("selectblanksimple","sidebar_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("sidebar_title_font_style",$sidebar_title_font_style);

			$sidebar_title_font_weight = new QodeField("selectblanksimple","sidebar_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel1->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$sidebar_link_text_transform = new QodeField("selectblanksimple","sidebar_link_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group2->addChild("row2",$row2);
			...
			$sidebar_link_font_style = new QodeField("selectblanksimple","sidebar_link_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("sidebar_link_font_style",$sidebar_link_font_style);

			$sidebar_link_font_weight = new QodeField("selectblanksimple","sidebar_link_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
