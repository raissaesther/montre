...
$error404Page->addChild("panel1",$panel1);
	...
	$panel1->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$title_404_text_transform = new QodeField("selectblanksimple","404_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$title_404_font_style = new QodeField("selectblanksimple","404_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("404_title_font_style",$title_404_font_style);

			$title_404_font_weight = new QodeField("selectblanksimple","404_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel1->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$text_404_text_transform = new QodeField("selectblanksimple","404_text_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group2->addChild("row2",$row2);
			...
			$text_404_font_style = new QodeField("selectblanksimple","404_text_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("404_text_font_style",$text_404_font_style);

			$text_404_font_weight = new QodeField("selectblanksimple","404_text_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
