...
qode_framework()->qodeOptions->addAdminPage("footer",$footerPage);
	...
	$show_footer_top_container->addChild("group1",$group1);
		...
		$group1->addChild("row2",$row2);	
			...
			$footer_left_padding = new QodeField("textsimple","footer_left_padding","","Left Padding(px or %)","This is some description");
			$row2->addChild("footer_left_padding",$footer_left_padding);
			$footer_right_padding = new QodeField("textsimple","footer_right_padding","","Right Padding(px or %)","This is some description");
	...
	$show_footer_top_container->addChild("group3",$group3);
		...
		$group3->addChild("row1",$row1);
			...
			$footer_top_text_text_transform = new QodeField("selectblanksimple","footer_top_text_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group3->addChild("row2",$row2);
			...
			$footer_top_text_font_style = new QodeField("selectblanksimple","footer_top_text_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("footer_top_text_font_style",$footer_top_text_font_style);

			$footer_top_text_font_weight = new QodeField("selectblanksimple","footer_top_text_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$show_footer_top_container->addChild("group4",$group4);
		...
		$group4->addChild("row1",$row1);
			...
			$footer_top_link_text_transform = new QodeField("selectblanksimple","footer_top_link_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group4->addChild("row2",$row2);
			...
			$footer_top_link_font_style = new QodeField("selectblanksimple","footer_top_link_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("footer_top_link_font_style",$footer_top_link_font_style);

			$footer_top_link_font_weight = new QodeField("selectblanksimple","footer_top_link_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
