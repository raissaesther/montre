...
$fontsPage->addChild("panel2",$panel2);
	...
	$panel2->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$text_text_transform = new QodeField("selectblanksimple","text_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
...
$fontsPage->addChild("panel4",$panel4);
	...
	$panel4->addChild("group1",$group1);
		...
		$group1->addChild("row3",$row3);
			...
			$menu_texttransform = new QodeField("selectblanksimple","menu_texttransform","","Text Transform","This is some description",qode_get_text_transform_array());
...
$fontsPage->addChild("panel3",$panel3);
	...
	$panel3->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$page_subtitle_texttransform = new QodeField("selectblanksimple","page_subtitle_texttransform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group2->addChild("row2",$row2);
			...
			$page_subtitle_fontstyle = new QodeField("selectblanksimple","page_subtitle_fontstyle","","Font Style","This is some description",qode_get_font_style_array());
	...
	$panel3->addChild("group3",$group3);
		...
		$group3->addChild("row1",$row1);
			...
			$page_breadcrumb_texttransform = new QodeField("selectblanksimple","page_breadcrumb_texttransform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group3->addChild("row2",$row2);
			...
			$page_breadcrumb_fontstyle = new QodeField("selectblanksimple","page_breadcrumb_fontstyle","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("page_breadcrumb_fontstyle",$page_breadcrumb_fontstyle);
			$page_breadcrumb_fontweight = new QodeField("selectblanksimple","page_breadcrumb_fontweight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$fontsPage->addChild("panel5",$panel5);
	...
	$panel5->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$portfolio_filter_title_text_transform = new QodeField("selectblanksimple","portfolio_filter_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$portfolio_filter_title_font_style = new QodeField("selectblanksimple","portfolio_filter_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("portfolio_filter_title_font_style",$portfolio_filter_title_font_style);
			$portfolio_filter_title_font_weight = new QodeField("selectblanksimple","portfolio_filter_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$fontsPage->addChild("panel6",$panel6);
	...
	$panel6->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$portfolio_title_standard_list_text_transform = new QodeField("selectblanksimple","portfolio_title_standard_list_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$portfolio_title_standard_list_font_style = new QodeField("selectblanksimple","portfolio_title_standard_list_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("portfolio_title_standard_list_font_style",$portfolio_title_standard_list_font_style);
			$portfolio_title_standard_list_font_weight = new QodeField("selectblanksimple","portfolio_title_standard_list_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel6->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$portfolio_category_standard_list_text_transform = new QodeField("selectblanksimple","portfolio_category_standard_list_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group2->addChild("row2",$row2);
			...
			$portfolio_category_standard_list_font_style = new QodeField("selectblanksimple","portfolio_category_standard_list_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("portfolio_category_standard_list_font_style",$portfolio_category_standard_list_font_style);
			$portfolio_category_standard_list_font_weight = new QodeField("selectblanksimple","portfolio_category_standard_list_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel6->addChild("group3",$group3);
		...
		$group3->addChild("row1",$row1);
			...
			$portfolio_title_list_text_transform = new QodeField("selectblanksimple","portfolio_title_list_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group3->addChild("row2",$row2);
			...
			$portfolio_title_list_font_style = new QodeField("selectblanksimple","portfolio_title_list_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("portfolio_title_list_font_style",$portfolio_title_list_font_style);
			$portfolio_title_list_font_weight = new QodeField("selectblanksimple","portfolio_title_list_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel6->addChild("group4",$group4);
		...
		$group4->addChild("row1",$row1);
			...
			$portfolio_category_list_text_transform = new QodeField("selectblanksimple","portfolio_category_list_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group4->addChild("row2",$row2);
			...
			$portfolio_category_list_font_style = new QodeField("selectblanksimple","portfolio_category_list_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("portfolio_category_list_font_style",$portfolio_category_list_font_style);
			$portfolio_category_list_font_weight = new QodeField("selectblanksimple","portfolio_category_list_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$fontsPage->addChild("panel61",$panel61);
	...
	$group1 = new QodeGroup("Title Style for Big Images, Big Slider, Full Width Slider, Masonry Gallery and Gallery Layout","Define title styles for portfolio single big images, big slider and gallery layout.");
	$panel61->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$portfolio_single_big_title_text_transform = new QodeField("selectblanksimple","portfolio_single_big_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$portfolio_single_big_title_font_style = new QodeField("selectblanksimple","portfolio_single_big_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("portfolio_single_big_title_font_style",$portfolio_single_big_title_font_style);
			$portfolio_single_big_title_font_weight = new QodeField("selectblanksimple","portfolio_single_big_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$group2 = new QodeGroup("Title Style for Small Images, Small Slider, Gallery, Gallery Right, Fixed Left, Fixed Right Layout","Define title styles for portfolio single small images and small slider layout.");
	$panel61->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$portfolio_single_small_title_text_transform = new QodeField("selectblanksimple","portfolio_single_small_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group2->addChild("row2",$row2);
			...
			$portfolio_single_small_title_font_style = new QodeField("selectblanksimple","portfolio_single_small_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("portfolio_single_small_title_font_style",$portfolio_single_small_title_font_style);
			$portfolio_single_small_title_font_weight = new QodeField("selectblanksimple","portfolio_single_small_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel61->addChild("group3",$group3);
		...
		$group3->addChild("row1",$row1);
			...
			$portfolio_single_meta_title_text_transform = new QodeField("selectblanksimple","portfolio_single_meta_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group3->addChild("row2",$row2);
			...
			$portfolio_single_meta_title_font_style = new QodeField("selectblanksimple","portfolio_single_meta_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("portfolio_single_meta_title_font_style",$portfolio_single_meta_title_font_style);
			$portfolio_single_meta_title_font_weight = new QodeField("selectblanksimple","portfolio_single_meta_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel61->addChild("group4",$group4);
		...
		$group4->addChild("row1",$row1);
			...
			$portfolio_single_meta_text_text_transform = new QodeField("selectblanksimple","portfolio_single_meta_text_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group4->addChild("row2",$row2);
			...
			$portfolio_single_meta_text_font_style = new QodeField("selectblanksimple","portfolio_single_meta_text_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("portfolio_single_meta_text_font_style",$portfolio_single_meta_text_font_style);
			$portfolio_single_meta_text_font_weight = new QodeField("selectblanksimple","portfolio_single_meta_text_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$fontsPage->addChild("panel9",$panel9);
	...
	$panel9->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$blog_list_info_text_transform = new QodeField("selectblanksimple","blog_list_info_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$blog_list_info_font_style = new QodeField("selectblanksimple","blog_list_info_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_list_info_font_style",$blog_list_info_font_style);
			$blog_list_info_font_weight = new QodeField("selectblanksimple","blog_list_info_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$fontsPage->addChild("panel7",$panel7);	
	...
	$panel7->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$blog_large_image_ql_title_text_transform = new QodeField("selectblanksimple","blog_large_image_ql_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$blog_large_image_ql_title_font_style = new QodeField("selectblanksimple","blog_large_image_ql_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_large_image_ql_title_font_style",$blog_large_image_ql_title_font_style);
			$blog_large_image_ql_title_font_weight = new QodeField("selectblanksimple","blog_large_image_ql_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel7->addChild("group3",$group3);
		...
		$group3->addChild("row1",$row1);
			...
			$blog_masonry_title_text_transform = new QodeField("selectblanksimple","blog_masonry_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group3->addChild("row2",$row2);
			...
			$blog_masonry_title_font_style = new QodeField("selectblanksimple","blog_masonry_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_masonry_title_font_style",$blog_masonry_title_font_style);
			$blog_masonry_title_font_weight = new QodeField("selectblanksimple","blog_masonry_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel7->addChild("group4",$group4);
		...
		$group4->addChild("row1",$row1);
			...
			$blog_masonry_ql_title_text_transform = new QodeField("selectblanksimple","blog_masonry_ql_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group4->addChild("row2",$row2);
			...
			$blog_masonry_ql_title_font_style = new QodeField("selectblanksimple","blog_masonry_ql_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_masonry_ql_title_font_style",$blog_masonry_ql_title_font_style);
			$blog_masonry_ql_title_font_weight = new QodeField("selectblanksimple","blog_masonry_ql_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel7->addChild("group8",$group8);
		...
		$group8->addChild("row1",$row1);
			...
			$blog_large_image_ql_author_text_transform = new QodeField("selectblanksimple","blog_large_image_ql_author_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group8->addChild("row2",$row2);
			...
			$blog_large_image_ql_author_font_style = new QodeField("selectblanksimple","blog_large_image_ql_author_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_large_image_ql_author_font_style",$blog_large_image_ql_author_font_style);
			$blog_large_image_ql_author_font_weight = new QodeField("selectblanksimple","blog_large_image_ql_author_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel7->addChild("group5",$group5);
		...
		$group5->addChild("row1",$row1);
			...
			$blog_masonry_author_text_transform = new QodeField("selectblanksimple","blog_masonry_author_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group5->addChild("row2",$row2);
			...
			$blog_masonry_author_font_style = new QodeField("selectblanksimple","blog_masonry_author_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_masonry_author_font_style",$blog_masonry_author_font_style);
			$blog_masonry_author_font_weight = new QodeField("selectblanksimple","blog_masonry_author_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel7->addChild("group9",$group9);
		...
		$group9->addChild("row1",$row1);
			...
			$blog_chequered_with_image_title_text_transform = new QodeField("selectblanksimple","blog_chequered_with_image_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group9->addChild("row2",$row2);
			...
			$blog_chequered_with_image_title_font_style = new QodeField("selectblanksimple","blog_chequered_with_image_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_chequered_with_image_title_font_style",$blog_chequered_with_image_title_font_style);
			$blog_chequered_with_image_title_font_weight = new QodeField("selectblanksimple","blog_chequered_with_image_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel7->addChild("group10",$group10);
		...
		$group10->addChild("row1",$row1);
			...
			$blog_chequered_with_bgcolor_title_text_transform = new QodeField("selectblanksimple","blog_chequered_with_bgcolor_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group10->addChild("row2",$row2);
			...
			$blog_chequered_with_bgcolor_title_font_style = new QodeField("selectblanksimple","blog_chequered_with_bgcolor_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_chequered_with_bgcolor_title_font_style",$blog_chequered_with_bgcolor_title_font_style);
			$blog_chequered_with_bgcolor_title_font_weight = new QodeField("selectblanksimple","blog_chequered_with_bgcolor_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel7->addChild("group11",$group11);
		...
		$group11->addChild("row1",$row1);
			...
			$blog_animated_title_text_transform = new QodeField("selectblanksimple","blog_animated_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group11->addChild("row2",$row2);
			...
			$blog_animated_title_font_style = new QodeField("selectblanksimple","blog_animated_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_animated_title_font_style",$blog_animated_title_font_style);
			$blog_animated_title_font_weight = new QodeField("selectblanksimple","blog_animated_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel7->addChild("group12",$group12);
		...
		$group12->addChild("row1",$row1);
			...
			$blog_centered_title_text_transform = new QodeField("selectblanksimple","blog_centered_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group12->addChild("row2",$row2);
			...
			$blog_centered_title_font_style = new QodeField("selectblanksimple","blog_centered_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_centered_title_font_style",$blog_centered_title_font_style);
			$blog_centered_title_font_weight = new QodeField("selectblanksimple","blog_centered_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel7->addChild("group13",$group13);
		...
		$group13->addChild("row1",$row1);
			...
			$blog_centered_info_text_transform = new QodeField("selectblanksimple","blog_centered_info_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group13->addChild("row2",$row2);
			...
			$blog_centered_info_font_style = new QodeField("selectblanksimple","blog_centered_info_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_centered_info_font_style",$blog_centered_info_font_style);
			$blog_centered_info_font_weight = new QodeField("selectblanksimple","blog_centered_info_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$fontsPage->addChild("panel8",$panel8);
	...
	$panel8->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$blog_single_title_text_transform = new QodeField("selectblanksimple","blog_single_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$blog_single_title_font_style = new QodeField("selectblanksimple","blog_single_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_single_title_font_style",$blog_single_title_font_style);
			$blog_single_title_font_weight = new QodeField("selectblanksimple","blog_single_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel8->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$blog_single_ql_title_text_transform = new QodeField("selectblanksimple","blog_single_ql_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group2->addChild("row2",$row2);
			...
			$blog_single_ql_title_font_style = new QodeField("selectblanksimple","blog_single_ql_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("blog_single_ql_title_font_style",$blog_single_ql_title_font_style);
			$blog_single_ql_title_font_weight = new QodeField("selectblanksimple","blog_single_ql_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
...
$fontsPage->addChild("panel10",$panel10);
	...
	$panel10->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$contact_form_heading_texttransform = new QodeField("selectblanksimple","contact_form_heading_texttransform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group1->addChild("row2",$row2);
			...
			$contact_form_heading_fontstyle = new QodeField("selectblanksimple","contact_form_heading_fontstyle","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("contact_form_heading_fontstyle",$contact_form_heading_fontstyle);
			$contact_form_heading_fontweight = new QodeField("selectblanksimple","contact_form_heading_fontweight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel10->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$contact_form_section_title_texttransform = new QodeField("selectblanksimple","contact_form_section_title_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group2->addChild("row2",$row2);
			...
			$contact_form_section_title_fontstyle = new QodeField("selectblanksimple","contact_form_section_title_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("contact_form_section_title_fontstyle",$contact_form_section_title_fontstyle);
			$contact_form_section_title_fontweight = new QodeField("selectblanksimple","contact_form_section_title_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
	...
	$panel10->addChild("group3",$group3);
		...
		$group3->addChild("row1",$row1);
			...
			$contact_form_section_subtitle_texttransform = new QodeField("selectblanksimple","contact_form_section_subtitle_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
		...
		$group3->addChild("row2",$row2);
			...
			$contact_form_section_subtitle_fontstyle = new QodeField("selectblanksimple","contact_form_section_subtitle_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("contact_form_section_subtitle_fontstyle",$contact_form_section_subtitle_fontstyle);
			$contact_form_section_subtitle_fontweight = new QodeField("selectblanksimple","contact_form_section_subtitle_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
