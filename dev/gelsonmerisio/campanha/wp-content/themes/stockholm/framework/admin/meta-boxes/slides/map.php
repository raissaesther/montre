<?php
if(!function_exists('qode_map_slides_meta_fields')) {
	function qode_map_slides_meta_fields()
	{
...
//Select Slide Type
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_type", $qodeSlideType);
...
//Select Slide Image
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_image_settings", $qodeSlideImageSettings);
...
//Select Slide Video
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_video_settings", $qodeSlideVideoSettings);
...
//Select Slide General
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_layout", $qodeSlideGeneral);
...
//Select Slide Title
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_title", $qodeSlideTitle);
		...
		$title_fontstyle = new QodeMetaField("selectblanksimple", "qode_slide-title-font-style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("qode_slide-title-font-style", $title_fontstyle);
		$title_fontweight = new QodeMetaField("selectblanksimple", "qode_slide-title-font-weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		$row2->addChild("qode_slide-title-font-weight", $title_fontweight);
		$title_texttransform = new QodeMetaField("selectblanksimple", "qode_slide-title-text-transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
...
//Select Slide Subtitle
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_subtitle", $qodeSlideSubtitle);
		...
		$subtitle_fontstyle = new QodeMetaField("selectblanksimple", "qode_slide-subtitle-font-style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("qode_slide-subtitle-font-style", $subtitle_fontstyle);
		$subtitle_fontweight = new QodeMetaField("selectblanksimple", "qode_slide-subtitle-font-weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		$row2->addChild("qode_slide-subtitle-font-weight", $subtitle_fontweight);
		$subtitle_transform = new QodeMetaField("selectblanksimple", "qode_slide-subtitle-text-transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
...
//Select Slide Text
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_text", $qodeSlideText);
		...
		$text_fontstyle = new QodeMetaField("selectblanksimple", "qode_slide-text-font-style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("qode_slide-text-font-style", $text_fontstyle);
		$text_fontweight = new QodeMetaField("selectblanksimple", "qode_slide-text-font-weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		$row2->addChild("qode_slide-text-font-weight", $text_fontweight);
		$text_transform = new QodeMetaField("selectblanksimple", "qode_slide-text-text-transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
...
//Select Slide Graphic
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_graphic", $qodeSlideGraphic);
...
//Select Slide Buttons
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_buttons", $qodeSlideButtons);
...
//Select Slide Content Positioning
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("slides_content_positioning", $qodeSlideContentPositioning);
	...
	add_action('qode_meta_boxes_map', 'qode_map_slides_meta_fields',30);
}