								...
								<div class="col-lg-12">
									...
									<div class="qodef-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfolioimg']) == false) { ?> style="display: none"<?php } ?>
											class="qodef-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfolioimg']) == true) { echo qodef_get_attachment_thumb_url(stripslashes($portfolio_image['portfolioimg'])); } ?>" alt=""
												 class="qodef-media-image img-thumbnail"/>
										</div>
										<div style="display: none"
											 class="qodef-media-meta-fields">
											<input type="hidden" class="qodef-media-upload-url"
												   ...
												   value="<?php echo esc_url(stripslashes($portfolio_image['portfolioimg'])); ?>"/>
											<input type="hidden"
												   class="qodef-media-upload-height"
												   name="qode_options_theme[media-upload][height]"
												   value=""/>
								...
								<div class="col-lg-12">
									...
									<div class="qodef-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == false) { ?> style="display: none"<?php } ?>
											class="qodef-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == true) { echo qodef_get_attachment_thumb_url(stripslashes($portfolio_image['portfoliovideoimage'])); } ?>" alt=""
												 class="qodef-media-image img-thumbnail"/>
										</div>
										<div style="display: none"
											 class="qodef-media-meta-fields">
											<input type="hidden" class="qodef-media-upload-url"
												   ...
												   value="<?php echo esc_url(stripslashes($portfolio_image['portfoliovideoimage'])); ?>"/>
											<input type="hidden"
												   class="qodef-media-upload-height"
												   name="qode_options_theme[media-upload][height]"
												   value=""/>
		...
		while (isset($portfolio_images[$no-1])) {
			...
			if ($portfolio_img_type == "image") {
				...
				<div class="qodef-portfolio-images qodef-portfolio-media" rel="<?php echo esc_attr($no); ?>">
					<div class="qodef-portfolio-toggle-holder">
						<div class="qodef-portfolio-toggle qodef-toggle-desc">
							<span class="number"><?php echo esc_html($no); ?></span><span class="qodef-toggle-inner">Image - <em>(<?php echo esc_attr(stripslashes($portfolio_image['portfolioimgordernumber'])); ?>, <?php echo esc_attr(stripslashes($portfolio_image['portfoliotitle'])); ?>)</em></span>
						</div>
						<div class="qodef-portfolio-toggle qodef-portfolio-control">
							...
							<div class="qodef-section-content">
								<div class="container-fluid">
									<div class="row">
										...
										<div class="col-lg-2">
											<em class="qodef-field-description">Order Number</em>
											<input type="text" class="form-control qodef-input qodef-form-element" id="portfolioimgordernumber_<?php echo esc_html($no); ?>" name="portfolioimgordernumber[]" value="<?php echo isset($portfolio_image['portfolioimgordernumber'])?stripslashes($portfolio_image['portfolioimgordernumber']):""; ?>" placeholder="">
										</div>
										<div class="col-lg-8">
											<em class="qodef-field-description">Image Title (works only for Gallery portfolio type selected) </em>
											<input type="text" class="form-control qodef-input qodef-form-element" id="portfoliotitle_<?php echo esc_html($no); ?>" name="portfoliotitle[]" value="<?php echo isset($portfolio_image['portfoliotitle'])?stripslashes($portfolio_image['portfoliotitle']):""; ?>" placeholder="">
										</div>
									</div>
			...
			<?php
				...
				<div class="qodef-portfolio-videos qodef-portfolio-media" rel="<?php echo esc_attr($no); ?>">
					<div class="qodef-portfolio-toggle-holder">
						<div class="qodef-portfolio-toggle qodef-toggle-desc">
							<span class="number"><?php echo esc_html($no); ?></span><span class="qodef-toggle-inner">Video - <em>(<?php echo esc_attr(stripslashes($portfolio_image['portfolioimgordernumber'])); ?>, <?php echo esc_attr(stripslashes($portfolio_image['portfoliotitle'])); ?></em>) </span>
						</div>
						<div class="qodef-portfolio-toggle qodef-portfolio-control">
	...
	public function render($factory) {
		...
		while (isset($portfolios[$no-1])) {
			...
			<div class="qodef-portfolio-additional-item" rel="<?php echo esc_attr($no); ?>">
				<div class="qodef-portfolio-toggle-holder">
					<div class="qodef-portfolio-toggle qodef-toggle-desc">
						<span class="number"><?php echo esc_html($no); ?></span><span class="qodef-toggle-inner">Additional Sidebar Item - <em>(<?php echo esc_attr(stripslashes($portfolio['optionlabelordernumber'])); ?>, <?php echo esc_attr(stripslashes($portfolio['optionLabel'])); ?>)</em></span>
					</div>
					<div class="qodef-portfolio-toggle qodef-portfolio-control">
						...
						<div class="qodef-section-content">
							<div class="container-fluid">
								...
								<div class="row next-row">
									<div class="col-lg-12">
										<em class="qodef-field-description">Enter Full URL for Item Text Link</em>
										<input type="text" class="form-control qodef-input qodef-form-element" id="optionUrl_<?php echo esc_attr($no); ?>" name="optionUrl[]" value="<?php echo esc_attr(stripslashes($portfolio['optionUrl'])); ?>" placeholder="">
									</div>
								</div>
							</div><!-- close div.qodef-section-content -->
						</div><!-- close div.container-fluid -->
		...
		<div id="qode-metaboxes-general" class="wrap qodef-page qodef-page-info">
			<div class="qodef-page-form">
				<div class="qodef-page-form-section-holder clearfix">
					<h3 class="qodef-page-section-title"><?php esc_html_e('Export/Import Options', 'qode'); ?></h3>
					<div class="qodef-page-form-section">
						<div class="qodef-field-desc">
				...
				<div class="qodef-page-form-section-holder clearfix">
					<h3 class="qodef-page-section-title"><?php esc_html_e('Export/Import Custom Sidebars', 'qode'); ?></h3>
					<div class="qodef-page-form-section">
						<div class="qodef-field-desc">
							<h4><?php esc_html_e('Export', 'qode'); ?></h4>
							<p><?php esc_html_e('Copy the code from this field and save it to a textual file to export your custom sidebars. Save that textual file somewhere so you can later use it to import custom sidebars if necessary.', 'qode'); ?></p>
						</div>
						<div class="qodef-section-content">
							<div class="container-fluid">
								<div class="row">
									<div class="col-lg-12">
										<textarea name="export_custom_sidebars" id="export_custom_sidebars" class="form-control qodef-form-element" rows="10" readonly><?php echo qode_export_custom_sidebars(); ?></textarea>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="qodef-page-form-section" >
						<div class="qodef-field-desc">
							<h4><?php esc_html_e('Import', 'qode'); ?></h4>
							<p><?php esc_html_e('To import custom sidebars, just paste the code you previously saved from the "Export" field into this field, and then click the "Import" button.', 'qode'); ?></p>
						</div>
					...
					<div class="qodef-page-form-section" >
						<div class="qodef-section-content">
							<div class="container-fluid">
								<div class="row">
									<div class="col-lg-12">
										<button type="button" class="btn btn-primary btn-sm " name="import" id="qodef-import-custom-sidebars-btn" data-waiting-message="<?php esc_html_e('Please wait', 'qode'); ?>" data-confirm-message="<?php esc_html_e('Are you sure, you want to import Options now?', 'qode'); ?>">Import</button>
					...
					<div class="qodef-page-form-section">
						<div class="qodef-section-content">
							<div class="alert alert-warning">
								<strong><?php _e('Important notes:', 'qode') ?></strong>
								<ul>
									<li><?php _e('Please note that import process will overide all your existing custom sidebars.', 'qode'); ?></li>
							</div>
						</div>
					</div>
				...
				<div class="qodef-page-form-section-holder clearfix">
					<h3 class="qodef-page-section-title"><?php esc_html_e('Export/Import Widgets', 'qode'); ?></h3>
					<div class="qodef-page-form-section">
						<div class="qodef-field-desc">
							<h4><?php esc_html_e('Export', 'qode'); ?></h4>
							<p><?php esc_html_e('Copy the code from this field and save it to a textual file to export your widgets. Save that textual file somewhere so you can later use it to import widgets if necessary.', 'qode'); ?></p>
						</div>
						<div class="qodef-section-content">
							<div class="container-fluid">
								<div class="row">
									<div class="col-lg-12">
										<textarea name="export_theme_options" id="export_options" class="form-control qodef-form-element" rows="10" readonly><?php echo qode_export_widgets_sidebars(); ?></textarea>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="qodef-page-form-section" >
						<div class="qodef-field-desc">
							<h4><?php esc_html_e('Import', 'qode'); ?></h4>
							<p><?php esc_html_e('To import widgets, just paste the code you previously saved from the "Export" field into this field, and then click the "Import" button.', 'qode'); ?></p>
						</div>
					...
					<div class="qodef-page-form-section" >
						<div class="qodef-section-content">
							<div class="container-fluid">
								<div class="row">
									<div class="col-lg-12">
										<button type="button" class="btn btn-primary btn-sm " name="import" id="qodef-import-widgets-btn" data-waiting-message="<?php esc_html_e('Please wait', 'qode'); ?>" data-confirm-message="<?php esc_html_e('Are you sure, you want to import Options now?', 'qode'); ?>">Import</button>
					...
					<div class="qodef-page-form-section">
						<div class="qodef-section-content">
							<div class="alert alert-warning">
								<strong><?php _e('Important notes:', 'qode') ?></strong>
								<ul>
									<li><?php _e('Please note that import process will overide all your existing widgets.', 'qode'); ?></li>
							</div>
						</div>
					</div>
