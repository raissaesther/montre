...
if(isset($qode_options['popup_menu_3rd_google_fonts']) && $qode_options['popup_menu_3rd_google_fonts'] !== '-1') {
	$popup_menu_3rd_style[] = 'font-family: '.str_replace('+', ' ', $qode_options['popup_menu_3rd_google_fonts']).', sans-serif';
}

if(isset($qode_options['popup_menu_3rd_fontsize']) && $qode_options['popup_menu_3rd_fontsize'] !== '') {
	$popup_menu_3rd_style[] = 'font-size: '.$qode_options['popup_menu_3rd_fontsize'].'px';
}

if(isset($qode_options['popup_menu_3rd_lineheight']) && $qode_options['popup_menu_3rd_lineheight'] !== '') {
	$popup_menu_3rd_style[] = 'line-height: '.$qode_options['popup_menu_3rd_lineheight'].'px';
}

if(isset($qode_options['popup_menu_3rd_letterspacing']) && $qode_options['popup_menu_3rd_letterspacing'] !== '') {
	$popup_menu_3rd_style[] = 'letter-spacing: '.$qode_options['popup_menu_3rd_letterspacing'].'px';
}
...
if(isset($qode_options['popup_menu_3rd_fontstyle']) && $qode_options['popup_menu_3rd_fontstyle'] !== '') {
	$popup_menu_3rd_style[] = 'font-style: '.$qode_options['popup_menu_3rd_fontstyle'];
}

if(isset($qode_options['popup_menu_3rd_texttransform']) && $qode_options['popup_menu_3rd_texttransform'] !== '') {
	$popup_menu_3rd_style[] = 'text-transform: '.$qode_options['popup_menu_3rd_texttransform'];
}
...
if(isset($qode_options['portfolio_single_meta_text_line_height']) && $qode_options['portfolio_single_meta_text_line_height'] !== '') {
	$portfolio_single_meta_text_style[] = 'line-height: '.$qode_options['portfolio_single_meta_text_line_height'].'px';
}
