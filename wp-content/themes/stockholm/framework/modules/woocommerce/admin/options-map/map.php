...
//Product single styles
		...
		$woo_product_single_enable_default_gallery_features = new QodeField("yesno", "woo_product_single_enable_default_gallery_features", "no", "Enable Default WooCommerce Product Gallery Features", "Enabling this option will add support for WooCommerce default zoom, swipe and lightbox features");
		$panel2->addChild("woo_product_single_enable_default_gallery_features", $woo_product_single_enable_default_gallery_features);
