...
//General
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("page_general", $qodeGeneral);
...
// Left Menu Area
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("page_left_menu", $qodeLeftMenuArea);
...
// Header
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("page_header", $qodeHeader);
...
// Title
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("page_title", $qodeTitle);
...
// Content Bottom
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("page_content_bottom", $qodeContentBottom);
...
// Blog
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("page_blog", $qodeBlog);
...
// Side Bar Area
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("page_side_bar", $qodeSideBar);
...
// SEO
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("page_seo", $qodeSeo);
	...
	add_action('qode_meta_boxes_map', 'qode_map_page_meta_fields',10);
}