<?php
if(!function_exists('qode_map_portfolio_meta_fields')) {

	function qode_map_portfolio_meta_fields()
	{
...
//Portfolio Images
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("portfolio_images", $qodePortfolioImages);
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("portfolio_images_videos",$qodePortfolioImagesVideos);
...
//Portfolio Images/Videos 2
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("portfolio_images_videos2", $qodePortfolioImagesVideos2);
...
//Portfolio Additional Sidebar Items
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("portfolio_properties", $qodeAdditionalSidebarItems);
...
//General
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("portfolio_general", $qodeGeneral);
		...
		$qode_choose_number_of_portfolio_columns_container = new QodeContainer("qode_choose_number_of_portfolio_columns_container", "qode_choose-portfolio-single-view", "no", array("", "small-images", "small-slider", "big-images", "big-slider", "custom", "full-width-custom", "fullscreen-slider", "fullwidth-slider", "masonry-gallery", "fixed-right", "fixed-left", "wide-left", "wide-right"));
...
// Header
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("porfolio_header", $qodeHeader);
...
// Left Menu Area
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("porfolio_left_menu", $qodeLeftMenuArea);
...
// Title
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("porfolio_title", $qodeTitle);
...
// Content Bottom
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("portfolio_content_bottom_page", $qodeContentBottom);
...
// Side Bar Area
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("portfolio_side_bar", $qodeSideBar);
...
// SEO
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("portfolio_seo", $qodeSeo);
	...
	add_action('qode_meta_boxes_map', 'qode_map_portfolio_meta_fields',20);
}