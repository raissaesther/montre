...
if(!function_exists('qode_map_post_meta_fields')) {
	...
	function qode_map_post_meta_fields()
	{
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("post_general", $qodeGeneral);
...
// Left Menu Area
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("post_left_menu", $qodeLeftMenuArea);
...
// Header
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("post_header", $qodeHeader);
...
// Title
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("post_title", $qodeTitle);
...
// Content Bottom
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("post_content_bottom_page", $qodeContentBottom);
...
// Side Bar Area
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("post_side_bar", $qodeSideBar);
...
// Blog Chequered
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("post_blog_chequered", $qodeBlogChequered);
...
// SEO
		...
		qode_framework()->qodeMetaBoxes->addMetaBox("post_seo", $qodeSeo);
	...
	add_action('qode_meta_boxes_map', 'qode_map_post_meta_fields',40);
}