...
$contactPage->addChild("panel5",$panel5);
	...
	$panel5->addChild("group4",$group4);
		...
		$group4->addChild("row2",$row2);
			$cf7_custom_style_1_label_font_style = new QodeField("selectblanksimple","cf7_custom_style_1_label_font_style","","Font Style","This is some description",qode_get_font_style_array());
			$row2->addChild("cf7_custom_style_1_label_font_style",$cf7_custom_style_1_label_font_style);
			$cf7_custom_style_1_label_font_weight = new QodeField("selectblanksimple","cf7_custom_style_1_label_font_weight","","Font Weight","This is some description",qode_get_font_weight_array());
			$row2->addChild("cf7_custom_style_1_label_font_weight",$cf7_custom_style_1_label_font_weight);
			$cf7_custom_style_1_label_text_transform = new QodeField("selectblanksimple","cf7_custom_style_1_label_text_transform","","Text Transform","This is some description",qode_get_text_transform_array());
