...
if(!function_exists('qode_visualcomposer_options_map')) {
	...
	function qode_visualcomposer_options_map()
	{
		...
		$vc_grid_portfolio_filter_text_transform = new QodeField("selectblanksimple", "vc_grid_portfolio_filter_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$vc_grid_portfolio_filter_font_style = new QodeField("selectblanksimple", "vc_grid_portfolio_filter_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("vc_grid_portfolio_filter_font_style", $vc_grid_portfolio_filter_font_style);
		$vc_grid_portfolio_filter_font_weight = new QodeField("selectblanksimple", "vc_grid_portfolio_filter_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
