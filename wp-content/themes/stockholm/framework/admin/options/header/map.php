...
// Menu
		...
		$enable_wide_menu_background = new QodeField("yesno", "enable_wide_menu_background", "no", "Enable Full Width Background for Wide Dropdown Type", "Enabling this option will show full width background  for wide dropdown type");
		$panel4->addChild("enable_wide_menu_background", $enable_wide_menu_background);
...
// Select Search
		...
		$search_text_text_transform = new QodeField("selectblanksimple", "search_text_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$search_text_font_style = new QodeField("selectblanksimple", "search_text_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("search_text_font_style", $search_text_font_style);
		$search_text_font_weight = new QodeField("selectblanksimple", "search_text_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$search_icon_type = new QodeField('selectsimple', 'search_icon_type', '', 'Search Icon', '', array(
			'' => 'Font Awesome Icon',
			'font-elegant' => 'Font Elegant Icon',
			'font-linear' => 'Linear Icon'
		));
		$row2->addChild('search_icon_type', $search_icon_type);
...
// Side Area
		...
		$side_area_title_texttransform = new QodeField("selectblanksimple", "side_area_title_texttransform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$side_area_title_fontstyle = new QodeField("selectblanksimple", "side_area_title_fontstyle", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("side_area_title_fontstyle", $side_area_title_fontstyle);
		$side_area_title_fontweight = new QodeField("selectblanksimple", "side_area_title_fontweight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$sidearea_link_text_transform = new QodeField("selectblanksimple", "sidearea_link_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$sidearea_link_font_style = new QodeField("selectblanksimple", "sidearea_link_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("sidearea_link_font_style", $sidearea_link_font_style);

		$sidearea_link_font_weight = new QodeField("selectblanksimple", "sidearea_link_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$group_open_icon_group = new QodeGroup("Open Icon Style", "Define styles for side area open icon");
		$enable_side_area_container->addChild("group_open_icon_group", $group_open_icon_group);

		$row1 = new QodeRow();
		$group_open_icon_group->addChild("row1", $row1);

		$sidearea_open_icon_type = new QodeField("selectsimple", "sidearea_open_icon_type", "font-awesome", "Icon Type", "This is some description", array(
			'font-awesome' => 'Font Awesome',
			'font-elegant' => 'Font Elegant'
		));
		$row1->addChild("sidearea_open_icon_type", $sidearea_open_icon_type);
		...
		$sidearea_close_icon_color = new QodeField("textsimple", "sidearea_close_icon_size", "", "Fold Icon Size (px)", "This is some description");
		$row1->addChild("sidearea_close_icon_size", $sidearea_close_icon_color);
...
// Fullscreen Menu
		...
		$popup_menu_3rd_fontstyle = new QodeField("selectblanksimple", "popup_menu_3rd_fontstyle", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row3->addChild("popup_menu_3rd_fontstyle", $popup_menu_3rd_fontstyle);
		$popup_menu_3rd_fontweight = new QodeField("selectblanksimple", "popup_menu_3rd_fontweight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$popup_menu_3rd_texttransform = new QodeField("selectblanksimple", "popup_menu_3rd_texttransform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
...
// Header Top
    ...
    ", array(), array("dependence" => true, "dependence_hide_on_yes" => "", "dependence_show_on_yes" => "#qodef_header_top_area_container"));
		...
		$header_top_area_hide_on_mobile = new QodeField("yesno", "header_top_area_hide_on_mobile", "no", "Hide on Mobile Devices", "Enabling this option will hide Header Top on mobile devices");
		$header_top_area_container->addChild("header_top_area_hide_on_mobile", $header_top_area_hide_on_mobile);
