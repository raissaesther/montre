...
if(!function_exists('qode_gravityforms_options_map')) {
	/**
	 * WooCommerce options page
	 */
	function qode_gravityforms_options_map()
	{

		$gravityformsPage = new QodeAdminPage("18", "Gravity Forms");
		qode_framework()->qodeOptions->addAdminPage("Gravity Forms", $gravityformsPage);
...
// General
		...
		$gf_title_text_transform = new QodeField("selectblanksimple", "gf_title_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$gf_title_font_style = new QodeField("selectblanksimple", "gf_title_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("gf_title_font_style", $gf_title_font_style);

		$gf_title_font_weight = new QodeField("selectblanksimple", "gf_title_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$gf_label_text_transform = new QodeField("selectblanksimple", "gf_label_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$gf_label_font_style = new QodeField("selectblanksimple", "gf_label_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("gf_label_font_style", $gf_label_font_style);

		$gf_label_font_weight = new QodeField("selectblanksimple", "gf_label_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$gf_description_text_transform = new QodeField("selectblanksimple", "gf_description_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$gf_description_font_style = new QodeField("selectblanksimple", "gf_description_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("gf_description_font_style", $gf_description_font_style);

		$gf_description_font_weight = new QodeField("selectblanksimple", "gf_description_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
	...
	add_action('qode_options_map','qode_gravityforms_options_map',200);
