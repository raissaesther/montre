            ...
            <div class="qode-membership-main-wrapper clearfix">
                ...
                <?php } else { ?>
                    <div class="qode-login-register-content qode-user-not-logged-in">
                        <ul>
                            <li>
                                <a href="#qode-login-content"><?php esc_html_e( 'Login', 'qode_membership' ); ?></a>
                            </li>
                            <li>
                                <a href="#qode-register-content"><?php esc_html_e( 'Register', 'qode_membership' ); ?></a>
                            </li>
                            <li>
                                <a href="#qode-reset-pass-content"><?php esc_html_e( 'Reset Password', 'qode_membership' ); ?></a>
                            </li>
                        </ul>
