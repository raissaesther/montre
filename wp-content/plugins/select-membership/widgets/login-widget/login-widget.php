...
class QodeMembershipLoginRegister extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Select Login',
			array( 'description' => esc_html__( 'Login and register wordpress widget', 'qode_membership' ), )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( ! is_user_logged_in() ) {
			echo '<a href="#" class="qode-login-opener">' . esc_html__( 'Login', 'qode_membership' ) . '</a>';
